...
<html lang="en">
  <head>
    ...
    <title>Ömer Faruk Dilek | Kişisel Blog </title>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form action="../option/islem.php" method="POST">
              <h1>Admin Giriş</h1>
              <div>
                <input type="text" class="form-control" name="admin_kadi" placeholder="Kullanici Adı" required="" />
              </div>
              <div>
