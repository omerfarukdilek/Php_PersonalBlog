        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kategori_icon" placeholder="Icon kodu giriniz" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kategori_seourl" placeholder="Seo Url giriniz" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
